...
typedef struct _vif
{
    ...
    param apcli_wpapsk;
    param apcli_defaultkeyid;
    param apcli_key1type;
    param apcli_key1str;
    param apcli_key2type;
    param apcli_key2str;
    param apcli_key3type;
    param apcli_key3str;
    param apcli_key4type;
    param apcli_key4str;
	param apcli_macrepeateren;
} vif;
...
vif VIF =
{
    ...
    .AccessPolicy   = {NULL, "maclist_mode", NULL, NULL,  NULL},
    .AccessControlList  = {NULL, "maclist", NULL, NULL,  NULL},
	.apcli_enable       = {NULL, "apcli_enable", NULL, NULL,  NULL},
    .apcli_ssid         = {NULL, "apcli_ssid", NULL, NULL,  NULL},
    .apcli_bssid        = {NULL, "apcli_bssid", NULL, NULL,  NULL},
    .apcli_authmode     = {NULL, "apcli_authmode", NULL, NULL,  NULL},
    .apcli_encryptype   = {NULL, "apcli_encryptype", NULL, NULL,  NULL},
    .apcli_wpapsk       = {NULL, "apcli_wpapsk", NULL, NULL,  NULL},
    .apcli_defaultkeyid = {NULL, "apcli_defaultkeyid", NULL, NULL,  NULL},
    .apcli_key1type     = {NULL, "apcli_key1type", NULL, NULL,  NULL},
    .apcli_key1str      = {NULL, "apcli_key1str", NULL, NULL,  NULL},
    .apcli_key2type     = {NULL, "apcli_key2type", NULL, NULL,  NULL},
    .apcli_key2str      = {NULL, "apcli_key2str", NULL, NULL,  NULL},
    .apcli_key3type     = {NULL, "apcli_key3type",NULL, NULL,  NULL},
    .apcli_key3str      = {NULL, "apcli_key3str", NULL, NULL,  NULL},
    .apcli_key4type     = {NULL, "apcli_key4type", NULL, NULL,  NULL},
    .apcli_key4str      = {NULL, "apcli_key4str", NULL, NULL,  NULL},
    .apcli_macrepeateren= {NULL, "macrepeateren", "0", NULL,  NULL},
};
...
param CFG_ELEMENTS[] =
{
    ...
    */
    ...
    {"CountryRegionABand", "aregion", NULL, hooker, "0"},
    {"CountryCode", "country", NULL, hooker, NULL},
    {"BssidNum", "bssidnum", NULL, hooker,  "1"},
    ...
    {"AutoChannelSelect", "autoch", NULL, hooker, "1"},
    ...
    {"AccessPolicy0", "maclist_mode", NULL, hooker, "0"},
    {"AccessControlList0", "maclist", NULL, hooker, NULL},
    {"AccessPolicy1", "maclist_mode", NULL, hooker, "0"},
    {"AccessControlList1", "maclist", NULL, hooker, NULL},
    {"AccessPolicy2",  "maclist_mode", NULL, hooker, "0"},
    {"AccessControlList2", "maclist", NULL, hooker, NULL},
    {"AccessPolicy3",  "maclist_mode", NULL, hooker, "0"},
    {"AccessControlList3", "maclist", NULL, hooker, NULL},
    ...
    {"DfsSwDisable", NULL, NULL, NULL, NULL},
    ...
    {"ApCliSsid", NULL, NULL, hooker, NULL},
    {"ApCliBssid", NULL, NULL, hooker, NULL},
    {"ApCliAuthMode", NULL,NULL, hooker, NULL},
    {"ApCliEncrypType", NULL, NULL, hooker, NULL},
    {"ApCliWPAPSK", NULL, NULL, hooker, NULL},
    {"ApCliDefaultKeyID", NULL, NULL, hooker, "0"},
    {"ApCliKey1Type", NULL, NULL, hooker, "0"},
    {"ApCliKey1Str", NULL, NULL, hooker, NULL},
    {"ApCliKey2Type", NULL, NULL, hooker, "0"},
    {"ApCliKey2Str", NULL, NULL, hooker, NULL},
    {"ApCliKey3Type", NULL, NULL, hooker, "0"},
    {"ApCliKey3Str", NULL, NULL, hooker, NULL},
    {"ApCliKey4Type", NULL, NULL, hooker, "0"},
    {"ApCliKey4Str", NULL, NULL, hooker, NULL},
    ...
    {"WSC_UUID_Str1", "wsc_uuid_str", NULL, hooker, NULL},
    {"WSC_UUID_E1", "wsc_uuid_e", NULL, hooker, NULL},
    {"HT_MIMOPS", "mimops", NULL, hooker, "3"},
    {"G_BAND_256QAM", "g256qam", NULL, hooker, "1"},
    {"DBDC_MODE", "dbdc", NULL, hooker, "0"},
    {"txbf", "txbf", NULL, hooker, "0"},
	...
	{"RRMEnable", "rrmenable", NULL, hooker, "0"},
	{"FtSupport", "ftsupport", NULL, hooker, "1"}, 
	{"SKUenable", "skuenable", NULL, hooker, "0"},
    {"PERCENTAGEenable", "percentageenable", NULL, hooker, "0"},
    {"MACRepeaterEn", "macrepeateren", NULL, hooker, "0"},
	{"MACRepeaterOuiMode", "macrepeaterouimode", NULL, hooker, "2"},
};
...
void parse_dat(char * devname, char * datpath)
{
    ...
    do
    {
        ...
        *q = 0;
        ...
        {
        #if 0 //for debug
            if(strstr(k,"MACRepeaterEn"))
                printf("[CFG_ELEMENTS[%d].dat_key]<%s> == <%s>\n",n,CFG_ELEMENTS[n].dat_key, k);
		#endif	
...
void parse_uci(char * arg)
{
    ...
    uci_foreach_element(&uci_wireless->sections, e)
    {
        ...
        if(0 == strcmp(s->type, "wifi-iface"))
        {
			...
			if ( strncmp( value, "ra", 2 ) == 0 ) //对ra接口中配置参数的处理
			{
            ...
            PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].AccessPolicy, value);
            PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].AccessControlList, value);			
#if 0
...
#define STRNCPPP(dst,src) \
			...
			else if ( strncmp( value, "apcli", 5 ) == 0 ) //对apcli0中继接口配置参数的处理
			{
				printf("%s(),linsd test apcli wifi-iface: %s %d %d\n", __FUNCTION__, value, cur_dev,cur_vif );
				
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_enable, value);
				printf("%s(),linsd test apcli_enable wifi-iface: %s %d %d\n", __FUNCTION__, value, cur_dev,cur_vif );
				...
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_wpapsk, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_defaultkeyid, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key1type, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key1str, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key2type, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key2str, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key3type, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key3str, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key4type, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_key4str, value);
				PARSE_UCI_OPTION(wifi_cfg[cur_dev].vifs[cur_vif].apcli_macrepeateren, value);
			}
...
void hooker(FILE * fp, param * p, const char * devname)
{
    ...
    {
        VFPRINT(fp, p, "%d", wifi_cfg[N].vifnum - 1);
    }
    else if(0 == strcmp(p->dat_key, "EncrypType"))
    {
        for(i=0; i<wifi_cfg[N].vifnum - 1; i++)
        {
            if(i>0) FPRINT(fp, p, ";");
    ...
    else if(0 == strmatch(p->dat_key, "Key?Type"))  /* WEP */
    {
        ...
        for(j=0; j<wifi_cfg[N].vifnum - 1; j++)
        {
    ...
    else if(0 == strcmp(p->dat_key, "ApCliEnable"))
    {
		printf("%s(),linsd test apcli test  %d %d %s \n", __FUNCTION__, N, MBSSID_MAX - 1, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_enable.value );

    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_enable.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_enable.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliSsid"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_ssid.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_ssid.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliBssid"))
    {
    	//if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_bssid.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_bssid.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliAuthMode"))
    {
    	//if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_authmode.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_authmode.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliEncrypType"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_encryptype.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_encryptype.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliWPAPSK"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_wpapsk.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_wpapsk.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliDefaultKeyID"))
    {
   // 	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_defaultkeyid.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_defaultkeyid.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey1Type"))
    {
   // 	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key1type.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key1type.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey1Str"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key1str.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key1str.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey2Type"))
    {
	//if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key2type.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key2type.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey2Str"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX].apcli_key3str.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key2str.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey3Type"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key3str.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key3str.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey3Str"))
    {
    //	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key3str.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key3str.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey4Type"))
    {
   // 	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key4type.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key4type.value);
    }
    else if(0 == strcmp(p->dat_key, "ApCliKey4Str"))
    {
   // 	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key4str.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key4str.value);
    }
	else if(0 == strcmp(p->dat_key, "MACRepeaterEn"))
    {
   // 	if(strlen(wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_key4str.value) > 0)
			FPRINT(fp, p, wifi_cfg[N].vifs[MBSSID_MAX - 1].apcli_macrepeateren.value);
    }
#if 0
	...
	int valuelen = 0;
	int count = 0;
	if(wifi_cfg[N].vifs[i].AccessControlList.value)
	{
	valuelen = strlen(wifi_cfg[N].vifs[i].AccessControlList.value);

	for(count; count < valuelen; count++)
	{
		if(wifi_cfg[N].vifs[i].AccessControlList.value[count] == ' ')
			wifi_cfg[N].vifs[i].AccessControlList.value[count] = ';';			
	}

		
        FPRINT(fp, p, wifi_cfg[N].vifs[i].AccessControlList.value);	
	}
    }
    else if(0 == strmatch(p->dat_key, "AccessPolicy?")) 
    {
        ...
        FPRINT(fp, p, wifi_cfg[N].vifs[i].AccessPolicy.value);	
    }    
    else
    {
        FPRINT(fp, p, p->value);
...
void gen_dat(char * devname, char * datpath)
{
    ...
    for(i=0; i<sizeof(CFG_ELEMENTS)/sizeof(CFG_ELEMENTS[0]); i++)
    {
        ...
        printf("%s(), %s,%s.\n", __FUNCTION__, p->dat_key,p->value);
        if(p->value)
        {
...
void usage(void)
{
    ...
    printf("%2d. %s\n", j++, VIF.apcli_enable.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_ssid.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_bssid.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_authmode.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_encryptype.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_wpapsk.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_defaultkeyid.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key1type.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key1str.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key2type.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key2str.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key3type.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key3str.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key4type.uci_key);
    printf("%2d. %s\n", j++, VIF.apcli_key4str.uci_key);
}
...
int main(int argc, char ** argv)
{
    ...
    char * dev = NULL;
    char * dat = NULL;
	char datdefault[256] = {0};
    int test = 0;
	printf("-----uci2dat main()------------------------------------------>in 1\n");
    ...
    if(dev && dat)
    {		
		sprintf(datdefault,"%s.default",dat);
    	if((access(datdefault,F_OK))!=-1)   
		{   
			parse_dat(dev, datdefault); 
		}
		else
		{	
			parse_dat(dev, dat);
