...
function mtkwifi.character_escape(str)
...
function mtkwifi.apcli_connect(dev, vif)
    -- dev_vif can be
    ...
    if cfgs.ApCliEncrypType == "WEP" then
        ...
        if (cfgs.ApCliDefaultKeyID == "1") then
            os.execute("iwpriv "..vifname.." set ApCliKey1=\""..mtkwifi.character_escape(cfgs.ApCliKey1Str).."\"")
        elseif (cfgs.ApCliDefaultKeyID == "2") then
            os.execute("iwpriv "..vifname.." set ApCliKey2=\""..mtkwifi.character_escape(cfgs.ApCliKey2Str).."\"")
        elseif (cfgs.ApCliDefaultKeyID == "3") then
            os.execute("iwpriv "..vifname.." set ApCliKey3=\""..mtkwifi.character_escape(cfgs.ApCliKey3Str).."\"")
        elseif (cfgs.ApCliDefaultKeyID == "4") then
            os.execute("iwpriv "..vifname.." set ApCliKey4=\""..mtkwifi.character_escape(cfgs.ApCliKey4Str).."\"")
        end
    elseif cfgs.ApCliAuthMode == "WPAPSK"
        or cfgs.ApCliAuthMode == "WPA2PSK"
        or cfgs.ApCliAuthMode == "WPAPSKWPA2PSK" then
        os.execute("iwpriv "..vifname.." set ApCliWPAPSK=\""..mtkwifi.character_escape(cfgs.ApCliWPAPSK).."\"")
    end
    os.execute("iwpriv "..vifname.." set ApCliSsid=\""..mtkwifi.character_escape(cfgs.ApCliSsid1).."\"")
    os.execute("iwpriv "..vifname.." set ApCliAutoConnect=3")
    os.execute("iwpriv "..vifname.." set ApCliEnable=1")
    os.execute("ebtables -D INPUT -p IPv4 -i apcli+ --ip-proto udp --ip-sport 68 --ip-dport 67 -j DROP")
    os.execute("ebtables -D OUTPUT -p IPv4 -o apcli+ --ip-proto udp --ip-sport 67 --ip-dport 68 -j DROP")
    os.execute("ebtables -D INPUT -p IPv4 -i ! apcli+ --ip-proto udp --ip-sport 67 --ip-dport 68 -j DROP")
    os.execute("ebtables -I INPUT -p IPv4 -i ! apcli+ --ip-proto udp --ip-sport 67 --ip-dport 68 -j DROP")
    os.execute("ebtables -I INPUT -p IPv4 -i apcli+ --ip-proto udp --ip-sport 68 --ip-dport 67 -j DROP")
    os.execute("ebtables -I OUTPUT -p IPv4 -o apcli+ --ip-proto udp --ip-sport 67 --ip-dport 68 -j DROP")
end

function mtkwifi.__wps_ap_pin_start_all(ifname, pincode, wpsLock, attackNum)
    --os.execute("iwpriv "..ifname.." set WscConfMode=7")
    --os.execute("iwpriv "..ifname.." set WscConfStatus=2")
    --os.execute("iwpriv "..ifname.." set WscMode=1")
    --os.execute("iwpriv "..ifname.." set WscVendorPinCode="..pincode)
    --os.execute("iwpriv "..ifname.." set WscGetConf=1")
    os.execute("iwpriv "..ifname.." set WscSetupLockTime=0")
    os.execute("iwpriv "..ifname.." set WscMaxPinAttack="..attackNum)
    os.execute("iwpriv "..ifname.." set WscSetupLock="..wpsLock)
end

function mtkwifi.set_netgear_vie(vifname, mode)
    if mode == 0 then --ap mode
        os.execute("iwpriv "..vifname.." set vie=dd0b00146c0002020010000000")
    else --extender mode
        os.execute("iwpriv "..vifname.." set vie=dd0b00146c0002010000000000")
    end
end

function mtkwifi.__attach_dev_black_list_enable(ifname, devMac)
    os.execute("iwpriv "..ifname.." set AccessPolicy=2")
    os.execute("iwpriv "..ifname.."  set ACLAddEntry="..devMac)
    os.execute("iwpriv "..ifname.."  set ACLShowAll=1")
end
