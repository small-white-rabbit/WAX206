...
define KernelPackage/nf-flow-offload
  SUBMENU:=$(NF_MENU)
  TITLE:=Netfilter (nat)flow offload
  KCONFIG:= \
	CONFIG_NETFILTER_INGRESS=y \
	CONFIG_NF_FLOW_TABLE
  DEPENDS:=+kmod-nf-conntrack +kmod-nf-nat +kmod-nfnetlink
  FILES:= \
	$(LINUX_DIR)/net/netfilter/nf_flow_table.ko
  AUTOLOAD:= $(call AutoProbe,nf_flow_table)
endef

$(eval $(call KernelPackage,nf-flow-offload))
...
define KernelPackage/ipt-offload
  ...
  $(call AddDepends/ipt,+kmod-nf-flow-offload)
endef
...
define KernelPackage/nf-flow-table-netlink
  TITLE:=Netfilter flow table over NFNETLINK interface
  FILES:=$(LINUX_DIR)/net/netfilter/nf_flow_table_netlink.ko
  KCONFIG:=CONFIG_NF_FLOW_TABLE_NETLINK
  AUTOLOAD:=$(call AutoProbe,nf_flow_table_netlink)
  $(call AddDepends/nfnetlink,+kmod-nf-flow-offload)
endef

define KernelPackage/nf-flow-table-netlink/description
  Kernel modules support for operation flow table via NFNETLINK
endef

$(eval $(call KernelPackage,nf-flow-table-netlink))
