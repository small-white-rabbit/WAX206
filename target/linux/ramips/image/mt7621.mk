...
define Build/GJEncoder
  Version=`cat $(TOPDIR)/staging_dir/target-mipsel_24kc_musl-1.1.16/root-ramips/cfg/$(1)/system|grep "softVersion"|awk '{print $$3}'|sed "s/'//g"`;\
...
define Device/mt7621-rfb-nmbm
$(Device/DefaultFIT)
  DEVICE_DTS := mt7621-rfb-nmbm
  BLOCKSIZE := 128k
  IMAGE/sysupgrade.bin := append-kernel | pad-to $$$$(BLOCKSIZE) | append-rootfs | pad-rootfs | append-metadata
  DEVICE_TITLE := MediaTek MT7621 RFB (NAND with NMBM)
endef
TARGET_DEVICES += mt7621-rfb-nmbm
...
define Device/mt7621-ax-nand-wax202
$(Device/DefaultFIT)
  DEVICE_DTS := mt7621-ax-nand-wax202
  BLOCKSIZE := 128k
  IMAGE/sysupgrade.bin := append-kernel | pad-to $$$$(BLOCKSIZE) | append-rootfs | pad-rootfs | append-metadata
  DEVICE_TITLE := Netgear WAX202
  FLASH_NOR_BLOCK := 131072
  NTGR_SW_REGION  := US
  IMAGE_NAME = $$(2)-$$(shell cat $(TOPDIR)/staging_dir/target-mipsel_24kc_musl-1.1.16/root-ramips/cfg/$$(2)/system|grep "softVersion"|awk '{print $$$$3}'|sed "s/'//g"|sed "s/_/ /g"|awk '{print $$$$1}').img
  IMAGES := WAX202-UNENCRYPTED WAX202
  IMAGE/WAX202-UNENCRYPTED := $$(IMAGE/sysupgrade.bin) | PrepareImage WAX202
  IMAGE/WAX202 := $$(IMAGE/sysupgrade.bin) | GJEncoder WAX202
endef
TARGET_DEVICES += mt7621-ax-nand-wax202

define Device/mt7621-rfb-ax-nmbm
$(Device/DefaultFIT)
  DEVICE_DTS := mt7621-rfb-ax-nmbm
  BLOCKSIZE := 128k
  IMAGE/sysupgrade.bin := append-kernel | pad-to $$$$(BLOCKSIZE) | append-rootfs | pad-rootfs | append-metadata
  DEVICE_TITLE := MediaTek MT7621 RFB (802.11ax, NAND with NMBM)
endef
TARGET_DEVICES += mt7621-rfb-ax-nmbm
